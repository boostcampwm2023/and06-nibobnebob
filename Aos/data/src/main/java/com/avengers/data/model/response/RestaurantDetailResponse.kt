...
data class RestaurantDetailResponse(
    ...
    companion object :
        com.avengers.data.model.mapper.DomainMapper<RestaurantDetailResponse, RestaurantDetailData> {
...
data class ReviewSortResponse(
    ...
    companion object :
        com.avengers.data.model.mapper.DomainMapper<ReviewSortResponse, ReviewSortData> {
...
data class Reviews(
    ...
    companion object : com.avengers.data.model.mapper.DomainMapper<Reviews, ReviewsData> {
